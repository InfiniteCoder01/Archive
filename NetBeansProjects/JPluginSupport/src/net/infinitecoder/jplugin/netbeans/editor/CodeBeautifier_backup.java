...
class CodeBeautifier_backup {
    ...
    public static String beautify(String input) {
        return new CodeBeautifier_backup(input).beautify();
    }
    ...
    public CodeBeautifier_backup(String input) {
        this.input = input;
        length = input.length();
    ...
    public String beautify() {
        while (pos < length) {
            ...
            if (current == '"') processString();
            else if (current == '\'') processChar();
