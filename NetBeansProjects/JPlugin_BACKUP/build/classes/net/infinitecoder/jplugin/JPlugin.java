...
public class JPlugin {
    ...
    public static JCode printFunction = new JCode("auto str") {
        @Override
        public Value execute(Value... args) {
            System.out.print(args[0].cast("String"));
            return JPlugin.ZERO;
        }
    };
    public static JCode printlnFunction = new JCode("auto str") {
        @Override
        public Value execute(Value... args) {
            System.out.println(args[0].cast("String"));
            return JPlugin.ZERO;
        }
    };
    ...
    public JPlugin(String pathToFile) {
        ...
        this.test = false;
        activeVariables = new VariablesClass();
        activeFunctions = new FunctionsClass();
        activeClasses = new ClassesClass();
    }
    ...
    public void parse() {
        try {
            ...
            Lexer lexer = new Lexer(preproc.parse());
    ...
    public void createFunction(String name, String type, JCode jCode) {
        activeFunctions.put(name, type, jCode);
    }
    ...
    public void createVar(String name, String type, Value value) {
        activeVariables.put(name, type, value);
    }
