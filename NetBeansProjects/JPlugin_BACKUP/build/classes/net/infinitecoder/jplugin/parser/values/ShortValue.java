...
//        throw new classCastException("Can not cast " + value + " to " + type + "!");
    ...
    public Value operator(String operator, Value other) {
        ...
        if (other instanceof DoubleValue || other instanceof FloatValue || other instanceof LongValue || other instanceof ShortValue || other instanceof CharValue || other instanceof BoolValue) {
