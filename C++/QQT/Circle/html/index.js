...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    loadPackage({"files": [{"filename": "/Consolas.ttf", "start": 0, "end": 104144}, {"filename": "/test.png", "start": 104144, "end": 117385}], "remote_package_size": 117385});
...
var ASM_CONSTS = {
  11695: () => { addOnPostRun(function() { if (Module.canvas) Module.canvas.focus(); }); },  
 11767: ($0) => { var font = new FontFace(UTF8ToString($0).replaceAll(' ', '-').replaceAll('/', '-').replaceAll('.', '-'), FS.readFile(UTF8ToString($0)).buffer); font.load().then(f => document.fonts.add(f)); }
};
...
var ___start_em_js = Module['___start_em_js'] = 11424;
var ___stop_em_js = Module['___stop_em_js'] = 11695;
