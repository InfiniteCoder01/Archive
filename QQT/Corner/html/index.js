...
var ASM_CONSTS = {
  8671: () => { addOnPostRun(function() { if (Module.canvas) Module.canvas.focus(); }); },  
 8743: ($0) => { var font = new FontFace(UTF8ToString($0).replaceAll(' ', '-').replaceAll('/', '-').replaceAll('.', '-'), FS.readFile(UTF8ToString($0)).buffer); font.load().then(f => document.fonts.add(f)); }
};
...
var ___start_em_js = Module['___start_em_js'] = 8400;
var ___stop_em_js = Module['___stop_em_js'] = 8671;
